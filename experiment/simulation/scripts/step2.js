...
//         anim.to('#sampleimage > small', { duration: .25, opacity: 0 })
//             .to('#sampleimage', {
//                 duration: 1, y: -100, x: -230, onComplete: () => {
//                     sampleHovering = true;
//                     gsap.to('#addSampleButton', { duration: 1, opacity: 1 });
//                     gsap.to('#zeroButton', { duration: 1, opacity: 1 })
//                     gsap.to('#removeSampleButton', { duration: 1, opacity: 1 });
//                 }
//             });
//     }
// }
...
//                             if (frameObject.i == 0) {
//                                 gsap.to(frameObject, {
//                                     i: 2, ease: new SteppedEase.config(2), onUpdate: () => {
...
//         if (flaskAdded) {
//             reading = 0.0;
//             gsap.to('#sampleimage > small', { duration: .25, opacity: 1 });
//         }
//         common();
//     }
// }
...
// function common() {
//     document.querySelector('#sample-reading').innerHTML = `${reading.toPrecision(2)}g`;
...
//         var anim1 = gsap.timeline();
//         anim1.to('#placeflask', { duration: 2, y: -100, x: -180, onStart: () => animating = true })
//             .to('#placeflask', { duration: 1, y: -40 })
//             .to('#zeroButton', { duration: 1, opacity: 1 })
//             .to(readingObj, {
...
function hoverSample() {
    if (!sampleHovering && flaskAdded) {
        ...
        anim
            ...
            setInterval(() => {
                document.querySelector("#removesample").style.visibility = "visible";
                document.querySelector("#addsample").style.visibility = "visible";
              }, 1200);
    }
}
...
function zeroReading() {
    if (!task_done) {
        ...
        common();
        gsap.to("#sampleimage > small", { duration: 0.25, opacity: 1 });
        document.querySelector("#teartozero").style.visibility = "hidden";
...
function placeFlask() {
    if (!flaskAdded) {
        ...
        anim1
            ...
            document.querySelector("#teartozero").style.visibility = "visible";
